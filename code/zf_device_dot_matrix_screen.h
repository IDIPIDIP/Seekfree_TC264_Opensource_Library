...
#define DOT_MATRIX_SCREEN_SR0_PIN       (P20_1)
#define DOT_MATRIX_SCREEN_SR1_PIN       (P20_2)
#define DOT_MATRIX_SCREEN_SR2_PIN       (P00_12)
...
void dot_matrix_screen_shuangshan       (void);//点阵屏显示双闪图案
void dot_matrix_screen_zuozhuan         (void);//点阵屏显示左转图案
void dot_matrix_screen_youzhuan         (void);//点阵屏显示右转图案
void dot_matrix_screen_jinguang         (void);//点阵屏显示近光图案
void dot_matrix_screen_yuanguang        (void);//点阵屏显示远光图案
void dot_matrix_screen_wudeng           (void);//点阵屏显示雾灯图案
void dot_matrix_screen_cheneideng       (void);//点阵屏显示车内灯图案
void dot_matrix_screen_yuguaqi          (void);//点阵屏显示雨刷器图案
